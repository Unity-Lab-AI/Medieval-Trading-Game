...
const MainQuests = {
        ...
        quests: {
            ...
            act1_quest4: {
                ...
                objectives: [
                    ...
                    { type: 'visit', location: 'sunhaven', completed: false, description: 'Return to Sunhaven' },
                    { type: 'talk', npc: 'harbormaster', location: 'sunhaven', completed: false, description: 'Report your success to Harbormaster Elena' }
                ],
            ...
            act1_quest5: {
                ...
                difficulty: 'easy',
                objectives: [
                    // FIX CRITICAL-008: Changed from explore (invalid dungeon) to investigate (location search)
                    { type: 'investigate', location: 'sunhaven', completed: false, description: 'Search the harbor warehouse (press E to explore)' },
    ...
    act3: {
        ...
        regions: ['royal_capital', 'frostholm_village'],
        wealthGate: 50000,
        ...
        quests: {
            ...
            act3_quest3: {
                ...
                turnInLocation: 'frostholm_village',
                location: 'royal_capital',
                type: 'main',
                act: 3,
                actOrder: 3,
                ...
                difficulty: 'hard',
                objectives: [
                    { type: 'visit', location: 'frostholm_village', completed: false, description: 'Travel to Frostholm' },
                    { type: 'talk', npc: 'elder', location: 'frostholm_village', completed: false, description: 'Consult the northern sages' }
                ],
            ...
            act3_quest5: {
                ...
                difficulty: 'hard',
                objectives: [
                    { type: 'explore', dungeon: 'frostholm_village', rooms: 3, current: 0, description: 'Search the frozen passes for the convoy (press E)' },
                    { type: 'talk', npc: 'huntmaster', location: 'frostholm_village', completed: false, description: 'Report the convoy\'s route to Huntmaster Erik' }
                ],
    ...
    act4: {
        ...
        quests: {
            ...
            act4_quest2: {
                ...
                difficulty: 'hard',
                objectives: [
                    // FIX HIGH-006: Use 'decision' type (not 'choice') to match quest-system.js handler
                    { type: 'decision', options: ['pay_50000', 'fight_through'], completed: false, description: 'Choose: pay 50,000g toll or fight past guards' },
    ...
    act5: {
        ...
        quests: {
            ...
            act5_quest3: {
                ...
                objectives: [
                    { type: 'visit', location: 'shadow_dungeon', requireDoom: true, completed: false, description: 'Step through the portal (optional)' },
            ...
            act5_quest7: {
                ...
                unlocks: {
                    // FIX CRITICAL-010: Duplicate keys overwrite - use array for multiple achievements
                    achievements: ['main_story_complete', 'shadow_slayer'],
