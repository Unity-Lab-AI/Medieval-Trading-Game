...
// expose globally
window.ImmersiveExperienceIntegration = ImmersiveExperienceIntegration;

// register with Bootstrap - no more auto-start
Bootstrap.register('ImmersiveExperienceIntegration', () => ImmersiveExperienceIntegration.start(), {
