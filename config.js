...
const GameConfig = {
    ...
    // ═══════════════════════════════════════════════════════════════
    version: {
        game: '0.91.10',        // NPC death, trade locks, config overhaul
        file: '0.91.10',        // keeping pace with the darkness
    ...
    keybindings: {
        ...
        defaults: {
            ...
            map: 'n',             // N opens world map overlay (WASD reserved for panning)
            ...
            people: 'p',          // P for People panel
            properties: 'o',      // O for properties
