...
│   └── DebuggerReadme.md         # Debug console commands (55+ total)
│
├── .claude/                      # AI workflow files
│   ├── CLAUDE.md                 # Main instructions (read first always)
│   ├── PUSH-CONFIG.md            # Git push configuration
│   ├── TheCoder.md               # Additional coder persona
...
│   │   ├── hooks.md              # Hooks agent
│   │   ├── orchestrator.md       # Orchestrator agent
│   │   ├── planner.md            # Planner agent
│   │   ├── scanner.md            # Scanner agent
│   │   ├── unity-coder.md        # Unity coder agent
│   │   └── unity-persona.md      # Unity persona agent
│   │
...
├── FINALIZED.md                  # Generated finalized doc
├── ROADMAP.md                    # Generated roadmap doc
├── SKILL_TREE.md                 # Generated skill tree doc
├── TODO.md                       # Generated todo doc
│
├── src/
│   ├── css/
│   │   ├── styles.css            # Main CSS (~6000 lines)
│   │   ├── npc-systems.css       # NPC-specific styles
│   │   ├── party-panel.css       # Party panel styles
│   │   ├── tutorial.css          # Tutorial styles
│   │   ├── ui-enhancements.css   # UI enhancement styles
│   │   ├── z-index-system.css    # Z-index layering
│   │   └── base/
│   │       └── variables.css     # CSS variables
│   │
│   ├── data/
│   │   └── npcs/                 # NPC data files (JSON)
│   │       ├── authorities.json  # Authority NPCs
│   │       ├── bosses.json       # Boss NPCs
│   │       ├── common.json       # Common NPCs
│   │       ├── criminals.json    # Criminal NPCs
│   │       ├── merchants.json    # Merchant NPCs
│   │       └── service.json      # Service NPCs
│   │
│   └── js/
│       ├── core/                 # Core engine systems (no dependencies)
│       │   ├── game.js           # THE BIG ONE (~9000 lines)
│       │   ├── event-bus.js      # Inter-system communication
│       │   ├── event-manager.js  # Event management
│       │   ├── event-system.js   # Event system base
...
│       │   ├── leaderboard-features.js # Leaderboard functionality
│       │   └── safari-compat.js  # Safari browser compatibility
│       │
│       ├── config/               # Configuration
│       │   └── z-index-constants.js # Z-index layer constants
│       │
│       ├── data/                 # Static game data
│       │   ├── game-world.js     # 55+ locations, paths
│       │   ├── doom-world-config.js # Doom world configuration
│       │   ├── doom-world-npcs.js # Doom world NPC data
│       │   ├── exploration-config.js # Exploration configuration
│       │   ├── tutorial-world.js # Tutorial world data
│       │   └── items/
│       │       ├── item-database.js      # 200+ items
│       │       └── unified-item-system.js # Item unification
│       │
│       ├── systems/              # Game systems (have dependencies)
│       │   ├── current-task-system.js # Task tracking
│       │   │
│       │   ├── combat/           # Combat, dungeons, death
│       │   │   ├── combat-system.js       # Core combat
│       │   │   ├── death-cause-system.js  # Death tracking
│       │   │   ├── dungeon-exploration-system.js # Dungeon exploration
│       │   │   └── game-over-system.js    # Game over handling
│       │   │
│       │   ├── crafting/         # Recipes, gathering
│       │   │   ├── crafting-economy-system.js # Crafting economy
│       │   │   ├── crafting-engine.js     # Core crafting
│       │   │   └── resource-gathering-system.js # Resource gathering
│       │   │
│       │   ├── economy/          # Economy systems
│       │   │   └── transport-system.js    # Transport economy
│       │   │
│       │   ├── employee/         # Worker management
│       │   │   ├── companion-system.js    # Companion management
│       │   │   ├── employee-system.js     # Core employee system
│       │   │   ├── property-employee-bridge.js # Property-employee bridge
│       │   │   └── property-employee-ui.js # Employee UI
│       │   │
│       │   ├── npc/              # NPC schedules
│       │   │   └── npc-schedule-system.js # NPC scheduling
│       │   │
│       │   ├── progression/      # Achievements, quests, skills, reputation
│       │   │   ├── achievement-system.js  # 115+ achievements
│       │   │   ├── doom-quest-system.js   # Doom world quests
│       │   │   ├── doom-quests.js         # Doom quest data
│       │   │   ├── faction-system.js      # Faction reputation
│       │   │   ├── main-quests.js         # Main quest data
│       │   │   ├── quest-system.js        # Core quest system
│       │   │   ├── reputation-system.js   # Reputation system
│       │   │   ├── side-quests.js         # Side quest data
│       │   │   ├── skill-system.js        # Skill progression
│       │   │   └── tutorial-quests.js     # Tutorial quest data
│       │   │
│       │   ├── save/             # Save manager
│       │   │   └── save-manager.js        # Unified save/load
│       │   │
│       │   ├── story/            # Story systems
│       │   │   └── initial-encounter.js   # Initial encounter
│       │   │
│       │   ├── trading/          # Markets, prices, routes
│       │   │   ├── dynamic-market-system.js # Dynamic pricing
│       │   │   ├── financial-tracker.js   # Financial tracking
│       │   │   ├── market-price-history.js # Price history
│       │   │   ├── merchant-rank-system.js # Merchant ranks
│       │   │   ├── trade-route-system.js  # Trade routes
│       │   │   └── trading-system.js      # Core trading
│       │   │
│       │   ├── travel/           # Movement, mounts, ships
│       │   │   ├── gatehouse-system.js    # City gates
│       │   │   ├── mount-system.js        # Mount riding
│       │   │   ├── ship-system.js         # Ship travel
│       │   │   ├── travel-panel-map.js    # Travel map UI
│       │   │   └── travel-system.js       # Core travel
│       │   │
│       │   ├── tutorial/         # Tutorial systems
│       │   │   └── tutorial-manager.js    # Tutorial management
│       │   │
│       │   └── world/            # World state systems
│       │       ├── city-event-system.js   # City events
│       │       ├── city-reputation-system.js # City reputation
│       │       ├── day-night-cycle.js     # Visual lighting
│       │       ├── doom-world-system.js   # Alternate dimension
│       │       ├── dungeon-bonanza-system.js # Dungeon events
│       │       ├── weather-system.js      # Dynamic weather
│       │       └── world-state-manager.js # Location/world state
│       │
│       ├── ui/                   # User interface
│       │   ├── button-fix.js     # Button fixes
│       │   ├── credits-system.js # Credits display
│       │   ├── key-bindings.js   # Keyboard shortcuts
│       │   ├── location-panel-stack.js # Panel stacking
│       │   ├── perk-system.js    # Perk UI
│       │   ├── tutorial-highlighter.js # Tutorial highlighting
│       │   ├── ui-enhancements.js # UI enhancements
│       │   ├── ui-polish-system.js # UI polish
│       │   │
│       │   ├── components/       # Reusable UI components
│       │   │   ├── combat-modal.js        # Combat modals
│       │   │   ├── draggable-panels.js    # Draggable panel system
│       │   │   ├── modal-system.js        # Modal management
│       │   │   ├── panel-manager.js       # Panel coordination
│       │   │   ├── panel-update-manager.js # Dirty flag batching
│       │   │   ├── tooltip-system.js      # Tooltip system
│       │   │   └── ui-state-manager.js    # UI state manager
│       │   │
│       │   ├── panels/           # Panel implementations
│       │   │   ├── equipment-panel.js     # Equipment UI
│       │   │   ├── exploration-panel.js   # Exploration UI
│       │   │   ├── inventory-panel.js     # Inventory UI
│       │   │   ├── leaderboard-panel.js   # Leaderboard UI
│       │   │   ├── party-panel.js         # Party UI
│       │   │   ├── people-panel.js        # People/NPC UI
│       │   │   ├── random-event-panel.js  # Random events UI
│       │   │   ├── settings-panel.js      # Settings UI
│       │   │   └── trade-cart-panel.js    # Trade cart UI
│       │   │
│       │   └── map/              # World map rendering
│       │       ├── game-world-renderer.js # World rendering
│       │       └── map-renderer-base.js   # Base renderer
│       │
│       ├── npc/                  # NPC systems
│       │   ├── doom-npc-instruction-templates.js # Doom NPC templates
│       │   ├── npc-chat-ui.js    # Chat interface
│       │   ├── npc-combat-stats.js # NPC stat generation
│       │   ├── npc-data-embedded.js # Embedded NPC data
│       │   ├── npc-dialogue.js   # NPC dialogue system
│       │   ├── npc-encounters.js # NPC encounters
│       │   ├── npc-instruction-templates.js # NPC AI templates
│       │   ├── npc-manager.js    # NPC management
...
│       │   ├── property-income.js # Property income
│       │   ├── property-map-picker.js # Map property picker
│       │   ├── property-purchase.js # Property purchasing
│       │   ├── property-storage.js # Property storage
│       │   ├── property-system-facade.js # Property facade
│       │   ├── property-types.js # Building types
│       │   ├── property-ui.js    # Property UI
│       │   └── property-upgrades.js # Property upgrades
│       │
│       ├── effects/              # Visual effects
│       │   ├── animation-system.js       # Animation system
│       │   ├── environmental-effects-system.js # Environment effects
│       │   ├── immersive-experience-integration.js # Immersion effects
│       │   ├── menu-weather-system.js    # Menu weather
│       │   └── visual-effects-system.js  # Visual effects
│       │
│       ├── audio/                # Sound and music
│       │   ├── audio-system.js   # Sound effects
│       │   └── music-system.js   # Background music
│       │
│       ├── debooger/            # Debooger tools 🐛
│       │   ├── api-command-system.js # API debug commands
│       │   ├── debooger-command-system.js # Cheat codes 💀
│       │   └── performance-optimizer.js # Performance tools
│       │
│       ├── init/                 # Initialization
│       │   ├── bootstrap.js      # THE init system
│       │   ├── loading-manager.js # Loading screen
│       │   └── browser-compatibility.js # Browser compat
│       │
│       ├── utils/                # Utilities
...
│           ├── game-engine.js    # Old game engine
│           └── time-system.js    # Old time system
│
└── assets/
    ├── Music/                    # Background music
    │   ├── Start Menu screen(15sec time out before replay creating music loop).mp3
    │   ├── doom world1-4.mp3     # Doom world tracks
    │   ├── dungeon1-5.mp3        # Dungeon tracks
    │   └── normal world1-4.mp3   # Normal world tracks
    │
    └── images/                   # Game images
        ├── SocialImage.jpg       # Social media preview
        ├── tutorial-map-bg.png   # Tutorial map background
        ├── world-map-spring.png  # Spring backdrop
        ├── world-map-summer.png  # Summer backdrop
        ├── world-map-autumn.png  # Autumn backdrop
        ├── world-map-winter.png  # Winter backdrop
        ├── world-map-dungeon.png # Dungeon backdrop
        └── *-v7.9.png            # Versioned map variants
```
...
- **Removed** duplicate old files from root directory (audio-system.js, employee-system.js, game.js, etc.)
- **Updated** file structure documentation with accurate ASCII tree
- **Added** new files discovered in code review:
  - `src/css/npc-systems.css`, `party-panel.css`, `tutorial.css`, `ui-enhancements.css`, `z-index-system.css`
  - `src/css/base/variables.css` - CSS variables
  - `src/data/npcs/*.json` - NPC data files (6 JSON files)
  - `src/js/config/z-index-constants.js` - Z-index layer constants
  - `src/js/audio/music-system.js` - Background music
  - `src/js/systems/tutorial/tutorial-manager.js` - Tutorial management
  - `src/js/debooger/api-command-system.js` - API debug commands
  - `assets/Music/` - Background music tracks (14 mp3 files)
- **Updated** game.js reference: ~8000 lines → ~9000 lines
- **Updated** location count: 42 → 55+ locations
- **Updated** item count: 150+ → 200+ items
- **Files:** `READMEs/NerdReadme.md`, `READMEs/GameplayReadme.md`, `READMEs/DebuggerReadme.md`
